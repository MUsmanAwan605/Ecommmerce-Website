...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $Colors = Color::all();
        return view('admin.product.add', compact('category', 'Sizes', 'Colors'));
    }
    ...
    'Images.*' => 'image|mimes:jpeg,png,jpg,gif|max:2048'
        ...
        if ($request->hasFile('Images')) {
            foreach ($request->file('Images') as $image) {
                ...
                $image->move(public_path('uploads/products_img'), $filename);
    ...
    public function show(string $id)
    {
        ...
        return view('admin.product.show', compact('category', 'Sizes', 'Colors', 'Product','images'));
    ...
    public function edit(string $id)
    {
        ...
        $product_color =  $Product->product_colors->pluck('color_id')->toArray();
        $Colors = Color::whereNotIn('id', $product_color)->get();
        return view('admin.product.edit', compact('category', 'sizes', 'Colors', 'Product','images'));
    }
    ...
    'Images.*' => 'image|mimes:jpeg,png,jpg,gif|max:2048'
        ...
        if ($request->hasFile('Images')) {
            foreach ($request->file('Images') as $image) {
                $filename = time() . '_' . $image->getClientOriginalName();
                $image->move(public_path('uploads/products_img'), $filename); // Ensure the directory exists
                $filenames[] = $filename;
            }
        } else {
