                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="user-profile">
                                <div class="user-title">
                                    <p class="paragraph">Hello, {{ Auth::user()->fname }} {{ Auth::user()->lname }}</p>
                                            ...
                                            <div class="review-form">
                                                <div class=" account-inner-form">
                                                    <div class="review-form-name">
                                                        ...
                                                        <input type="text" id="firname" value="{{ Auth::user()->fname }}" class="form-control"
                                                            placeholder="First Name">
                                                    </div>
                                                    <div class="review-form-name">
                                                        <label for="latname" class="form-label">Last Name*</label>
                                                        <input type="text"  value="{{ Auth::user()->fname }}" id="latname" class="form-control"
                                                ...
                                                <div class=" account-inner-form">
                                                    <div class="review-form-name">
                                                        ...
                                                        <input type="email" value="{{ Auth::user()->email }}" id="gmail" class="form-control"
                                                            placeholder="user@gmail.com">
                                                    </div>
                                                    <div class="review-form-name">
                                                        <label for="telephone" class="form-label">Phone*</label>
                                                        <input type="tel" value="{{ Auth::user()->phone }}" id="telephone" class="form-control"
                                                ...
                                                <div class="review-form-name address-form">
                                                    ...
                                                    <input type="text"  value="{{ Auth::user()->address }}" id="addres" class="form-control"
