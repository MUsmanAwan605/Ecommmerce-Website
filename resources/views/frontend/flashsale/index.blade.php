                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                        <div class="product-img">
                            ...
                            @endphp
                            <img src="{{ asset('/uploads/flash_img/' . $Sale[0]) }}"
                                alt="product-img">
                            <div class="product-cart-items">
                                <a href="{{ route('product.detail',$Sale->id) }}" class="cart cart-item">
                                    <span>
                                ...
                                <form action="{{ route('wish.page.add', $Sale->id) }}" method="POST">
                                    @csrf
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <a href="{{ route('product.detail', $Sale->id) }}" class="product-details">{{ $Sale->prod }}
                                </a>
                                <div class="price">
                                    <span class="price-cut">{{ $Sale->prod_price }}</span>
                                    <span class="new-price">{{ $Sale->selling_price }}</span>
                                </div>
                            </div>
                        </div>
                        <form action="{{ route('cart.page.add',$Sale->id) }}" method="post">
                            @csrf
