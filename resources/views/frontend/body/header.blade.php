            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        <a href="{{ route('User.dashboard') }}"><span>Account</span></a>
                        <a href="{{route('order.tracking')}}"><span>Track Order</span></a>
                            ...
                            @auth
                                <div class="header-user">
                                    ...
                                    <a href="{{ route('User.dashboard') }}" class="btn btn-light"
                                        style="color: red; border: none;">{{ Auth::user()->fname }}
                                        {{ Auth::user()->lname }}</a>
                                </div>
                            @else
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-favourite">
                            <a href="{{ route('wish.page') }}" class="cart-item">
                                <span>
                                ...
                                <span>
                                    <svg width="35" height="28" viewBox="0 0 35 28" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#6E6D79" />
                                         <circle ({{ $cartCount ?? 0 }}) cx="26.9523" cy="8" r="8" fill="#AE1C9A"  />
                                            ...
                                            <div class="wrapper">
                                                <div class="wrapper-item">
                                                    <div class="wrapper-img">
                                                        ...
                                                        <img src="/uploads/products_img/{{ $item->prod_img }}"
                                                            alt="img">
                                                    </div>
                                                ...
                                                <div class="dropdown-item">
                                                    <div class="dropdown-list-item">
                                                        <span class="dropdown-img">
                                                            ...
                                                            <img src="/uploads/brand_img/{{ $category->b_img }}"
                                                                alt="">
                                                             <p>kcndjkcdnjk</p>
                                            ...
                                            <ul>
                                                @if ($products ?? false)
                                                    @foreach ($products as $product)
                                                        <li><a href="product-sidebar.html">{{ $product->prod }}</a>
                                                        </li>
                                                    @endforeach
                                                @endif
                                            </ul>
