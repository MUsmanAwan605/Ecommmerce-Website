                    ...
                    <div class="sidebar-section">
                        <div class="sidebar-wrapper">
                            ...
                            <div class="sidebar-item">
                                <form id="category-filter-form" action="{{ route('products.filter') }}" method="POST">
                                    @csrf
                                <ul class="sidebar-list">
                                    ...
                                    <li>
                                            ...
                                            onchange="submitFormWithSpinner();">
                        ...
                        {{-- <div class="sidebar-wrapper">
                            ...
                            <form id="ColorFilter" action="{{ route('color.filter') }}" method="post">
                                @csrf
                            <div class="sidebar-item">
                                <ul class="sidebar-list">
                                    @foreach ($colors as $color)
                                    <li>
                                        <input type="checkbox"  name="colors[]" value="{{ $color->id }}" onchange="ColorFilter();"
                                        {{ in_array($color->id,$colorsIds ?? []) ?'checked' : '' }}>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                ...
                                <a href="{{ route('product.detail',$product->id) }}" class="cart cart-item">
                                    <span>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('product.detail', $product->id) }}" class="product-details">{{ $product->prod }}
                                        </a>
                                        <div class="price">
                                ...
                                <div class="product-cart-btn">
                                    <button href="{{ route('cart.page.add',$product->id) }}" class="product-btn">Add To Cart</button>
                                </div>
                            </div>
                        </form>
                        </div>
...
<script>
    function ColorFilter() {
        ...
        // Submit the form
        document.getElementById('ColorFilter').submit();
    }
</script>
