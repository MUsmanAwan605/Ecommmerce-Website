        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 product-grid">
            ...
            <div class="col">
                <div class="card">
                    ...
                    @else
                    <img src="{{ asset('/uploads/products_img/' . $images[0]) }}" class="card-img-top" alt="Product Image">
                    @endif
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mt-3 fs-6">
                            ...
                            <a href="{{ route('admin.product.edit',$Product->id) }}"><p class="mb-0 ms-auto"><i class='bx bxs-edit'></i></a>
                                <form method="post" action="{{ route('admin.product.destroy', $Product->id) }}" class="delete-form">
                                    @csrf
                                    {{ method_field('DELETE') }}
