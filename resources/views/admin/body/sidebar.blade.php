...
<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            </li><li> <a href="{{ route('admin.sale.index') }}"><i class='bx bx-radio-circle'></i>Flash Sale</a>
            </li>
            </li><li> <a href="{{ route('admin.slider.index') }}"><i class='bx bx-radio-circle'></i>Slider</a>
            </li>
                <li> <a href="{{ route('admin.about.index') }}"><i class='bx bx-radio-circle'></i>About Us</a>
                </li>
                <li> <a href="ecommerce-add-new-products.html"><i class='bx bx-radio-circle'></i>Add New Products</a>
                </li>
                <li> <a href="{{ route('admin.order.index') }}"><i class='bx bx-radio-circle'></i>Orders</a>
                </li>
                <li> <a href="{{ route('admin.product_size.index') }}"><i class='bx bx-radio-circle'></i>Product Size</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.size.index') }}"><i class='bx bx-radio-circle'></i>Size</a>
                </li>
                <li> <a href="{{ route('admin.color.index') }}"><i class='bx bx-radio-circle'></i>Color</a>
                </li>
