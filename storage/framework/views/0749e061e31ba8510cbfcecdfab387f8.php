         ...
         <div class="card">
            <div class="row g-0">
              <div class="col-md-4 border-end">
                ...
                <img src="<?php echo e(asset('/uploads/products_img/' . $images[0])); ?>" class="img-fluid" alt="...">

                <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                    <?php if(is_array($images)): ?>
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!$loop->first): ?>
                    <div class="col"><img src="<?php echo e(asset('/uploads/products_img/' . $image)); ?>" width="70" class="border rounded cursor-pointer" alt=""></div>
                    <?php endif; ?>
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h4 class="card-title"><?php echo e($Product->prod); ?></h4>
                  ...
                  <div class="mb-3">
                    <span class="price h4"><?php echo e($Product->real_price); ?></span>
                    
                </div>
                  <p class="card-text fs-6"><?php echo e($Product->desc); ?></p>
                  <dl class="row">
                    <dt class="col-sm-3">Model:</dt>
                    <dd class="col-sm-9"><?php echo e($Product->model); ?></dd>

                    

                    <dt class="col-sm-3">Delivery</dt>
                    <dd class="col-sm-9"><?php echo e($Product->delivery); ?> </dd>
                  </dl>
                  <hr>
                  <div class="row row-cols-auto row-cols-1 row-cols-md-3 align-items-center">
                    ...
                    <div class="col">
                        ...
                        <div class="col">
                            <label class="form-label">Select size</label>
                            <div class="">
                          <?php $__currentLoopData = $Product->product_colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod_color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <label class="form-check form-check-inline">
                              <input type="radio"class="form-check-input"  name="select_size" checked="" class="custom-control-input">
                              <div class="form-check-label">
                                <?php echo e($prod_color->color->name); ?>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\website\resources\views/admin/product/show.blade.php ENDPATH**/ ?>