...
<section class="product arrival mt-5">
    ...
    <div class="container">
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        ...
                        <div class="product-img">
                            ...
                            <div class="product-cart-items">
                                <a href="<?php echo e(route('product.detail',$product->id)); ?>" class="cart cart-item">
                                    <span>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <a href="<?php echo e(route('product.detail', $product->id)); ?>" class="product-details"><?php echo e($product->prod); ?>

                                </a>
                                <div class="price">
                                    <span class="price-cut"><?php echo e($product->prod_price); ?></span>
                                    <span class="new-price"><?php echo e($product->selling_price); ?></span>
                                </div>
                            </div>
                        </div>
        ...
        <?php else: ?>
    <div class="alert alert-danger  text-center align-text-center" style="height: 60px; font-size: 25px">No Products Found</div>
    <?php endif; ?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\website\resources\views/frontend/product/index.blade.php ENDPATH**/ ?>