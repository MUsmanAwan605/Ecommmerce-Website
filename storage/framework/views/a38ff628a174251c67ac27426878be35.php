...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('web/assets/images/homepage-one/icon.png')); ?>">

    <!--title  -->
    <title>GET Your Product</title>


    <!--------------- swiper-css ---------------->
    <link rel="stylesheet" href="<?php echo e(asset('web/assets/css/swiper10-bundle.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('web/assets/css/swiper10-bundle.min.css')); ?>">
    <!--------------- bootstrap-css ---------------->
    <link rel="stylesheet" href="<?php echo e(asset('web/assets/css/bootstrap-5.3.2.min.css')); ?>">

    <!---------------------- Range Slider ------------------->
    <link rel="stylesheet" href="<?php echo e(asset('web/assets/css/nouislider.min.css')); ?>">

    <!---------------------- Scroll ------------------------>
    <link rel="stylesheet" href="<?php echo e(asset('web/assets/css/aos-3.0.0.css')); ?>">
            ...
            <div class="container">
                <div class="header-top">
                    <div class="header-profile">
                        <a href="<?php echo e(route('User.dashboard')); ?>"><span>Account</span></a>
                        <a href="<?php echo e(route('order.tracking')); ?>"><span>Track Order</span></a>
                        ...
                        <div class="header-contact d-none d-lg-block">
                            <?php if(auth()->guard()->check()): ?>
                                <div class="header-user">
                                    ...
                                    <a href="<?php echo e(route('User.dashboard')); ?>" class="btn btn-light"
                                        style="color: red; border: none;"><?php echo e(Auth::user()->fname); ?>

                                        <?php echo e(Auth::user()->lname); ?></a>
                                </div>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-light"
                                    style="color: red; border: none; margin-right: 10px;">LOGIN</a>
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-light"
                                        style="color: red; border: none;">SIGN UP</a>
                                <?php endif; ?>
                            <?php endif; ?>
        ...
        <div class="header-center-section d-none d-lg-block">
            <div class="container">
                <div class="header-center">
                    <div class="logo">
                        <a href="/">
                            <img src="/web/assets/images/logos/logo.webp" alt="logo">
                        </a>
                    </div>
                    <div class="header-cart-items">
                        ...
                        <div class="header-favourite">
                            <a href="<?php echo e(route('wish.page')); ?>" class="cart-item">
                                <span>
                        ...
                        <div class="header-cart">
                                ...
                                <span>
                                    <svg width="35" height="28" viewBox="0 0 35 28" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#6E6D79" />
                                         <circle (<?php echo e($cartCount ?? 0); ?>) cx="26.9523" cy="8" r="8" fill="#AE1C9A"  />
                                        <circle cx="26.9523" cy="8" r="8" fill="#AE1C9A" />
                                        <text x="26.9523" y="12" text-anchor="middle" fill="white" font-size="12px"
                                            font-family="Arial">
                            ...
                            <div class="cart-submenu">
                                            ...
                                            <div class="wrapper">
                                                <div class="wrapper-item">
                                                    <div class="wrapper-img">
                                                        ...
                                                        <img src="/uploads/products_img/<?php echo e($item->prod_img); ?>"
                                                            alt="img">
                                                    </div>
                                                    <div class="wrapper-content">
                                                        <h5 class="wrapper-title"><?php echo e($item->prod_title); ?></h5>
                                                        <div class="price">
                                                            <p class="new-price">$<?php echo e($item->price); ?></p>
                                ...
                                <div class="cart-wrapper-section">
                                    ...
                                    <div class="cart-btn">
                                        <a href="<?php echo e(route('cart.page')); ?>" class="shop-btn view-btn">View Cart</a>
                                    ...
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/dresses.webp"
                                                    alt="dress">
                                            </span>
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/bags.webp"
                                                    alt="Bags">
                                            </span>
                                            <span class="dropdown-text">
                                                Bags
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/sweaters.webp"
                                                    alt="sweaters">
                                            </span>
                                            <span class="dropdown-text">
                                                Sweaters
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/shoes.webp"
                                                    alt="sweaters">
                                            </span>
                                            <span class="dropdown-text">
                                                Boots
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/gift.webp"
                                                    alt="gift">
                                            </span>
                                            <span class="dropdown-text">
                                                Gifts
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/sneakers.webp"
                                                    alt="sneakers">
                                            </span>
                                            <span class="dropdown-text">
                                                Sneakers
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/watch.webp"
                                                    alt="watch">
                                            </span>
                                            <span class="dropdown-text">
                                                Watches
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/ring.webp"
                                                    alt="ring">
                                            </span>
                                            <span class="dropdown-text">
                                                Gold Ring
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/cap.webp"
                                                    alt="cap">
                                            </span>
                                            <span class="dropdown-text">
                                                Cap
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/glass.webp"
                                                    alt="glass">
                                            </span>
                                            <span class="dropdown-text">
                                                Sunglasses
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="/web/assets/images/homepage-one/category-img/baby.webp"
                                                    alt="baby">
                                            </span>
                                            <span class="dropdown-text">
                                                Baby Shop
                                                ...
                                                <div class="dropdown-item">
                                                    <div class="dropdown-list-item">
                                                        <span class="dropdown-img">
                                                            ...
                                                            <img src="/uploads/brand_img/<?php echo e($category->b_img); ?>"
                                                                alt="">
                                                             <p>kcndjkcdnjk</p>
                            ...
                            <li class="mega-menu">
                                ...
                                <div class="shop-menu">
                                            ...
                                            <ul>
                                                <?php if($products ?? false): ?>
                                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="product-sidebar.html"><?php echo e($product->prod); ?></a>
                                                        </li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </ul>
                                    ...
                                    <div class="shop-menu-img">
                                        <img src="/web/assets/images/homepage-one/empty-wishlist.webp" alt="img">
                                    </div>
                                </div>
                            </li>
...
<?php /**PATH C:\xampp\htdocs\website\resources\views/frontend/body/header.blade.php ENDPATH**/ ?>