<section class="product footer">
            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        <div class="logo">
                            <img src="/frontend/assets/images/logos/footer-logo.webp" alt="logo">
                        </div>
                        ...
                        <div class="footer-link contact-link">
                            <div class="address">
                                ...
                                <div class="details">
                                    ...
                                    <p>City Railway Colony, iiChundighar Road</p>
                                </div>
                            </div>
    ...
    <!--------------- jQuery ---------------->
    <script src="<?php echo e(asset('web/assets/js/jquery_3.7.1.min.js')); ?>"></script>

    <!--------------- bootstrap-js ---------------->
    <script src="<?php echo e(asset('web/assets/js/bootstrap_5.3.2.bundle.min.js')); ?>"></script>

    <!--------------- Range-Slider-js ---------------->
    <script src="<?php echo e(asset('web/assets/js/nouislider.min.js')); ?>"></script>

    <!--------------- scroll-Animation-js ---------------->
    <script src="<?php echo e(asset('web/assets/js/aos-3.0.0.js')); ?>"></script>

    <!--------------- swiper-js ---------------->
    <script src="<?php echo e(asset('web/assets/js/swiper10-bundle.min.js')); ?>"></script>

    <!--------------- additional-js ---------------->
    <script src="<?php echo e(asset('web/assets/js/shopus.js')); ?>"></script>


</body>

</html>
<?php /**PATH C:\xampp\htdocs\website\resources\views/frontend/body/footer.blade.php ENDPATH**/ ?>